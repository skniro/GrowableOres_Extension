...
public class AlchemyblockentityRenderer implements BlockEntityRenderer<Alchemyblockentity, AlchemyBlockEntityRenderState> {
    ...
    @Override
    public void render(AlchemyBlockEntityRenderState state, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState cameraState) {
...
/*        itemRenderer.renderItem(stack, ItemDisplayContext.GUI, getLightLevel(entity.getWorld(),
    ...
    public void updateRenderState(Alchemyblockentity entity, AlchemyBlockEntityRenderState state, float tickProgress, Vec3 cameraPos, @Nullable ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
