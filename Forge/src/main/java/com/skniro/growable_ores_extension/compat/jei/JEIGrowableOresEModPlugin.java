...
public class JEIGrowableOresEModPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<AlchemyCraftingRecipe> craftingRecipes = recipeManager.getAllRecipesFor(AlchemyRecipeType.Cane_Converter_TYPE.get()).stream().map(RecipeHolder::value).toList();
